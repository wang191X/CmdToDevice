...
/*
  ...
  Peter E. Mellquist
*/
//char snmpwalk_cpp_version[]="@(#) SNMP++ $Id: snmpWalk.cpp 1575 2009-08-02 20:15:13Z katz $";
...
int main(int argc, char **argv)
{
  ...
  int objects  = 0;
   ...
   Oid oid("1.3.6.1.4.1.3902.1017.3.7.1.4");
   //Oid oid("1.3.6.1.2.1.31.1.1.1.1");                      // default is beginning of MIB 
